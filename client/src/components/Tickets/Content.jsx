...
function Content() {
	...
	return (
		<>
		<EditTicketModal ticket={ticket} modalIsOpen={modalIsOpen} setIsOpen={setIsOpen}  />
		{/* Darken </> */}
		<div className="mt-7 overflow-x-auto">
			<table className="m-auto whitespace-nowrap">
				<tbody>
					{tickets &&
						tickets.tickets.slice(0, 7).map((ticket, index) => (
							<tr
								tabIndex="0"
							...
							>
								...
								<td className="pl-5">
									<div className="flex items-center">
										<BsPencilFill className="text-gray-400" />
										<p className="text-sm leading-none text-gray-600 ml-2">
											{ticket.author.name}
										</p>
									</div>
